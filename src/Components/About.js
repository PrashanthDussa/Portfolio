                    ...
                    <div className="text-container">
                        ...
                        <div className="text-container-paragraph">
                            <p className={props.dark ? "dark-text-container-text" : "light-text-container-text"}>
                                I am pursuing my Masters in Computer Science at Arizona State University, expected to graduate in May 2024. I hold a Bachelors Degree in Computer Science from DR BR Ambedkar National Institute of Technology Jalandhar, completed in June 2021.
                                <br></br>
                                <br></br>
