...
export default function Navbar(props){
    ...
    return(
        <nav className={props.dark? 'dark-nav' : 'light-nav'} id='navbar'>
            <img src={props.dark ? 'https://PrashanthDussa.github.io/Portfolio/Images/logo-name-dark.svg' : '/Images/logo-name-light.svg'} className='logo-name-light' alt='name-logo'></img>
