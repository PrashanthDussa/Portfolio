...
export default function Navbar(props){
    return(
        <nav className={props.dark? 'dark-nav' : 'light-nav'}>
            <img src={props.dark ? '/Images/logo-name-dark.svg' : '/Images/logo-name-light.svg'} className='logo-name-light'></img>
            ...
            <img src={props.dark ? '/Images/lightIcon.svg' : '/Images/darkIcon.svg'} className='dark-light-icon' onClick={props.setTheme}></img>
        </nav>
    )
}